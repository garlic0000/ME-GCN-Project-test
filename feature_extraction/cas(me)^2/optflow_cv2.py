...
def save_flow_to_image(flow, output_path, frame_index):
    ...
    # 保存为图像文件
    cv2.imwrite(os.path.join(output_path, f"flow_x_{frame_index:04d}.jpg"), flow_x_img)
    cv2.imwrite(os.path.join(output_path, f"flow_y_{frame_index:04d}.jpg"), flow_y_img)
