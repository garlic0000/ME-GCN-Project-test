...
do     
    ...
    /opt/conda/envs/newCondaEnvironment/bin/python /kaggle/working/ME-GCN-Project/train.py --dataset $DATASET --output $OUTPUT --subject ${i}  # for training
    /opt/conda/envs/newCondaEnvironment/bin/python /kaggle/working/ME-GCN-Project/eval.py --dataset $DATASET --output $OUTPUT --subject ${i}   # for evaluation
done

#output final metrics
/opt/conda/envs/newCondaEnvironment/bin/python /kaggle/working/ME-GCN-Project/calc_final_score.py --output $OUTPUT